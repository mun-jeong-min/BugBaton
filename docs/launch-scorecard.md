...
The release threshold is all categories at 9.0 or higher. Distribution is the
only category below it and remains there until the public package and release
exist and can be installed by name.
